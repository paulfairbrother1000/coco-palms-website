...
export default function HomePage() {
  return <>
    <section className="hero">
      ...
      <div className="hero-content"><div className="hero-copy-panel"><span className="eyebrow light">Jolly Harbour · Antigua</span><h1 className="hero-title">Welcome to Coco Palms</h1><p>Your private waterfront escape in the Caribbean.</p><div className="hero-actions"><Link className="button" href="/rates-and-availability">Get Quotation</Link></div></div></div>
    </section>
    ...
    <section className="intro section"><div className="intro-copy"><span className="eyebrow">Welcome to Coco Palms</span><h2>Space to slow down, right on the water</h2><p>Coco Palms is a contemporary 4-bedroom villa on Harbour Island in the gated Jolly Harbour community. Gather around the pool, dine beneath the covered terrace and step onto the private dock as the sun settles over the water.</p><Link className="text-link" href="/the-villa">Explore the villa <ArrowRight size={18} /></Link></div><div className="intro-image"><Image src="/images/cocopalmshero4.jpg" alt="Coco Palms outdoor living beside the pool" fill sizes="(max-width: 900px) 100vw, 55vw" /></div></section>
