...
const tiles = [
  ...
  { title: "Interior", href: "/gallery#interior", image: "/images/gallery/interior/image1.jpg", copy: "Light-filled spaces designed for relaxed time together." },
...
export default function HomePage() {
  return <>
    ...
    <section className="intro section"><div><span className="eyebrow">Welcome to Coco Palms</span><h2>Space to slow down, right on the water</h2></div><div><p>Coco Palms is a contemporary four-bedroom villa on Harbour Island in the gated Jolly Harbour community. Gather around the pool, dine beneath the covered terrace and step onto the private dock as the sun settles over the water.</p><Link className="text-link" href="/the-villa">Explore the villa <ArrowRight size={18} /></Link></div></section>
