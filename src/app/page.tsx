...
export default function HomePage() {
  return <>
    <section className="hero">
      ...
      <div className="hero-content"><div className="hero-copy-panel"><span className="eyebrow light">Jolly Harbour · Antigua</span><h1 className="hero-title">Welcome to Coco Palms</h1><p>Your private waterfront escape in the Caribbean.</p><div className="hero-actions"><Link className="button" href="/rates-and-availability">Get Quotation</Link><Link className="text-link light" href="/rates-and-availability">View availability <ArrowRight size={18} /></Link></div></div></div>
    </section>
    ...
    <section className="quote-invitation section"><div><span className="eyebrow light">Plan your stay</span><h2>See your personalised quotation in moments</h2><p>Choose your dates and party size. We will check current availability and calculate the stay using Coco Palms’ published rates, taxes and fees.</p></div><Link className="button button-gold" href="/rates-and-availability">Get Quotation</Link></section>
  </>;
}
