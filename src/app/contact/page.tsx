...
export const metadata={title:"Contact",description:"Contact Coco Palms about a private waterfront villa stay in Jolly Harbour, Antigua.",alternates:{canonical:"/contact"}};
